...
export function PricingPageContent() {
  ...
  const comparisonRows = [
    {
      label: t("public.cmpCore"),
      starter: included,
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpAiSupervisor"),
      starter: t("public.notIncluded"),
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpWebsiteBuilder"),
      starter: t("public.notIncluded"),
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpEmployeePortal"),
      starter: t("public.notIncluded"),
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpCustomerPortal"),
      starter: t("public.notIncluded"),
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpAiReports"),
      starter: t("public.notIncluded"),
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpMileage"),
      starter: t("public.notIncluded"),
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpPhotosSignatures"),
      starter: t("public.notIncluded"),
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpStripe"),
      starter: t("public.notIncluded"),
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpHealthDashboard"),
      starter: t("public.notIncluded"),
      professional: included,
      enterprise: included,
    },
    {
      label: t("public.cmpMultiLocation"),
      starter: t("public.notIncluded"),
      professional: t("public.notIncluded"),
      enterprise: included,
    },
    {
      label: t("public.cmpOnboarding"),
      starter: t("public.notIncluded"),
      professional: t("public.notIncluded"),
      enterprise: included,
    },
  ...
  const faqs = [
    ...
    {
      question: t("public.faqOnboardingQ"),
      answer: t("public.faqOnboardingA"),
    },
  ];

  const highlights = [
    {
      label: t("public.pricingHighlightConnectedOpsLabel"),
      value: t("public.pricingHighlightConnectedOpsValue"),
    },
    {
      label: t("public.pricingHighlightBuiltGrowthLabel"),
      value: t("public.pricingHighlightBuiltGrowthValue"),
    },
    {
      label: t("public.pricingHighlightSupportLabel"),
      value: t("public.pricingHighlightSupportValue"),
    },
    {
      label: t("public.pricingHighlightProfessionalLabel"),
      value: t("public.pricingHighlightProfessionalValue"),
    },
  ];
      ...
      <main className="mx-auto w-full max-w-7xl px-4 pb-20 pt-8 sm:px-6 lg:px-8 lg:pt-12">
            ...
            <div className="space-y-6">
              ...
              <div className="max-w-2xl">
                ...
                <h1 className="text-4xl font-semibold leading-tight text-slate-950 sm:text-5xl">
                  {t("public.pricingHeroTitle")}
                </h1>
                <p className="mt-4 text-base leading-7 text-slate-600 sm:text-lg">
                  {t("public.pricingHeroCopy")}
                </p>
              </div>
        ...
        <section className="mt-10 grid gap-5 lg:grid-cols-3">
          {planCards.map((plan) => (
            <article
              key={plan.name}
              className={`relative flex h-full flex-col overflow-hidden rounded-[2rem] border bg-white p-6 shadow-sm transition ${plan.highlighted ? "border-blue-300 ring-2 ring-blue-200 shadow-[0_24px_50px_rgba(37,99,235,0.12)]" : "border-slate-200"}`}
            >
              {plan.highlighted ? (
                <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-400" />
              ) : null}
              <div
                className={`inline-flex w-fit rounded-full px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] ${plan.highlighted ? "bg-blue-50 text-blue-700" : plan.name === t("public.pricingEnterpriseName") ? "bg-slate-900 text-white" : "bg-slate-100 text-slate-700"}`}
              >
                {plan.badge}
              </div>
              <div className="mt-4">
                ...
                <p
                  className={`mt-2 rounded-2xl px-4 py-3 text-sm leading-6 ${plan.highlighted ? "bg-blue-50 text-blue-950" : "bg-slate-50 text-slate-700"}`}
                >
                  {plan.description}
                </p>
              </div>
              ...
              <div className="mt-6 flex items-end gap-2">
                <p
                  className={`text-5xl font-semibold ${plan.highlighted ? "text-blue-700" : "text-slate-950"}`}
                >
                  {plan.priceMonthly}
                </p>
        ...
        <section
          ...
          className="mt-12 rounded-[2rem] border border-amber-200 bg-gradient-to-r from-amber-50 via-white to-blue-50 p-6 shadow-sm sm:p-8"
        >
          <p className="text-sm font-semibold uppercase tracking-[0.16em] text-amber-700">
            {t("public.foundingPartnerEyebrow")}
          </p>
          <h2 className="mt-2 text-3xl font-semibold text-slate-950">
            {t("public.foundingPartnerTitle")}
          </h2>
          <p className="mt-2 text-base text-slate-700">
            {t("public.foundingPartnerPricingSubtitle")}
          </p>
          <p className="mt-3 text-sm font-semibold text-slate-900">
            {t("public.foundingPartnerSpotsAvailable", {
              count: String(FOUNDING_PARTNER_SPOTS),
            })}
          </p>
          <p className="mt-1 text-sm text-slate-600">
            {t("public.foundingPartnerLimitedTo", {
              count: String(FOUNDING_PARTNER_SPOTS),
            })}
          </p>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <article className="rounded-2xl border border-slate-200 bg-white p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">
                {t("public.foundingPartnerRegularPriceLabel")}
              </p>
            ...
            <article className="rounded-2xl border border-amber-300 bg-amber-50 p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.14em] text-amber-700">
                {t("public.foundingPartnerPriceLabel")}
              </p>
              <p className="mt-2 text-3xl font-semibold text-slate-950">
                {foundingPartnerPrice}
              ...
              <p className="mt-1 text-sm font-medium text-amber-800">
                {t("public.foundingPartnerForLife")}
              </p>
            </article>
          </div>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <p className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700">
              {t("public.foundingPartnerBenefitLockedPricing")}
            </p>
            <p className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700">
              {t("public.foundingPartnerBenefitFreeOnboarding")}
            </p>
            <p className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700">
              {t("public.foundingPartnerBenefitWebsiteBuilder")}
            </p>
            <p className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700">
              {t("public.foundingPartnerBenefitPrioritySupport")}
            </p>
            <p className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700">
              {t("public.foundingPartnerBenefitEarlyAi")}
            </p>
            <p className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700">
              {t("public.foundingPartnerBenefitFounderAccess")}
            </p>
            <p className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700">
              {t("public.foundingPartnerBenefitRoadmap")}
            </p>
            <p className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700">
              {t("public.foundingPartnerBenefitRecognition")}
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.16em] text-blue-700">
                {t("public.featureComparison")}
              </p>
              <h2 className="mt-2 text-3xl font-semibold text-slate-950">
                {t("public.featureComparisonTitle")}
              </h2>
            </div>
            <p className="max-w-xl text-sm leading-6 text-slate-600">
              {t("public.featureComparisonSubtitle")}
            </p>
          </div>
            ...
            <table className="min-w-[760px] w-full border-separate border-spacing-0 text-sm">
              <thead>
                <tr className="text-left text-slate-500">
                  ...
                  <th className="border-b border-slate-200 px-4 py-3 font-medium">
                    {t("public.pricingStarterName")}
                  </th>
                  <th className="border-b border-slate-200 px-4 py-3 font-medium text-blue-700">
                    {t("public.pricingProfessionalName")}
                  </th>
                  <th className="border-b border-slate-200 px-4 py-3 font-medium">
                    {t("public.pricingEnterpriseName")}
                  </th>
                </tr>
              </thead>
              <tbody>
                {comparisonRows.map((row, index) => (
                  ...
                  >
                    ...
                    <td className="border-b border-slate-100 px-4 py-4 text-slate-600">
                      {tick(row.starter, included)}
                    </td>
                    <td className="border-b border-slate-100 px-4 py-4 text-slate-600">
                      {tick(row.professional, included)}
                    </td>
                    <td className="border-b border-slate-100 px-4 py-4 text-slate-600">
                      {tick(row.enterprise, included)}
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        <section className="mt-16 grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[2rem] border border-blue-200 bg-gradient-to-br from-blue-700 via-sky-600 to-cyan-500 p-8 text-white shadow-[0_20px_60px_rgba(37,99,235,0.18)]">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-100">
              {t("public.whyProfessional")}
            </p>
            <h2 className="mt-3 text-3xl font-semibold">
              {t("public.whyProfessionalTitle")}
            </h2>
            <p className="mt-4 text-sm leading-6 text-blue-50">
              {t("public.whyProfessionalCopy")}
            </p>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-sky-300">
                {t("public.readyToSeeLive")}
              </p>
              <h2 className="mt-2 text-3xl font-semibold">
                {t("public.operateWithConfidence")}
              </h2>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">
                {t("public.pricingFinalCtaCopy")}
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link
