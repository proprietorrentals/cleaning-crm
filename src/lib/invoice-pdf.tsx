      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.brandRow}>
            ...
            <Text style={{ fontSize: 12, color: "#0b1e3a", fontWeight: "bold" }}>ServiceOS</Text>
          </View>
          <Text style={styles.title}>INVOICE</Text>
          <Text style={styles.subtitle}>Operate with Confidence.</Text>
        </View>
        ...
        <View style={styles.footer}>
          ...
          <Text>Generated by ServiceOS</Text>
        </View>
      </Page>
    </Document>
  );
