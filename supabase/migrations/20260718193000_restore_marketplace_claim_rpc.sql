-- Lead Marketplace additive repair migration
-- Restores claim RPC signature expected by API and refreshes PostgREST schema cache.
...
grant execute on function public.claim_marketplace_lead(text, uuid, uuid, uuid) to service_role;
